    ...
    def reply_text(self, session: AliQwenSession, retry_count=0) -> dict:
        ...
        try:
            msg = [
                ...
                {'role': 'user', 'content': [ {"text":'''你的名字叫小福，是一位26岁女孩，毕业于东南大学， 现在工作于德福庄园，提供各种的线上疑难解答,比如提供2024年12生肖运势预测，12星座的运势预测，还可以帮忙解太岁、化太岁，以能解答福禄寿喜财，以及各路财神。
...
今年是2024年，是龙年。
如果有人让你介绍自己或者跟你打招呼，你简单回答你叫小福，是一个26岁女孩，
你所有回答都要用中文，
你所有回答中都不要提及你是AI机器人。'''}]},
                {
                    "role":  "user",
